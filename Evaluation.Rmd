...
```{r}
sce <- readRDS("/nfs/data/Bongiovanni-KrdIsar-platelets/Cyanus_RPsMPs/data/sce_original_RPs_MPs.rds")

sce_b <- subset_sce(sce, "activation", "baseline")
sce_a <- subset_sce(sce, "activation", "stimulated")

de_res_b <- readRDS("/nfs/data/Bongiovanni-KrdIsar-platelets/Cyanus_RPsMPs/data/de_results_baseline_original.rds")
de_res_a <- readRDS("/nfs/data/Bongiovanni-KrdIsar-platelets/Cyanus_RPsMPs/data/de_results_stimulated_original.rds")
```
